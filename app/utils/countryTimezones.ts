// Generated from the IANA tzdata zone.tab shipped with the system.
// Maps an ISO 3166-1 alpha-2 country code to the IANA timezones used there.
//
// Zone order is tzdata's own, which lists a country's principal zone first
// within each offset region -- that is what makes New York, Mexico City,
// Moscow and Toronto the representatives of their groups rather than an
// alphabetical accident. Do not sort this.
//
// Country names are resolved at runtime with Intl.DisplayNames, so this table
// holds codes only and stays valid in any display language.
